            ...
            <Grid className="demo-grid-1">
              <Cell col={4}>
                ...
                >
                  ...
                  <CardText>
                    Basic counter web app created to practice fundamental
                    concepts in React including: JSX, Rendering to the DOM, &
                    Handling Events
                  </CardText>
                  <CardActions border>
                    <Button
              ...
              <Cell col={4}>
                ...
                >
                  ...
                  <CardText>
                    ...
                    Game logic written in JavaScript and webpage design written
                    in HTML & CSS, utilizing Canvas API.
                  </CardText>
                  <CardActions border>
                    <Button
                      style={{ color: "#000" }}
            ...
            <Grid className="demo-grid-2">
              <Cell col={4}>
                ...
                >
                  ...
                  <CardText>
                    ...
                    Life as a web application. Webpages developed in PHP, HTML,
                    & CSS, while game logic written in JavaScript.
                  </CardText>
                  <CardActions border>
                    <Button
                      style={{ color: "#000" }}
              ...
              <Cell col={4}>
                ...
                >
                  ...
                  <CardText>
                    Text-based fighting simulation game that used characters
                    from “Ben 10”, coded in C++.
                  </CardText>
                  <CardActions border>
                    <Button
                      style={{ color: "#000" }}
